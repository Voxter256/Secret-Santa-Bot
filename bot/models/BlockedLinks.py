...
class BlockedLink(Base):
    ...
    blocker = relationship("Participant", uselist=False,
        backref=backref('blocker_link'), foreign_keys=participant_id)
    blocked = relationship("Participant", uselist=False, 
        backref=backref('blocked_link'), foreign_keys=blocked_id)
